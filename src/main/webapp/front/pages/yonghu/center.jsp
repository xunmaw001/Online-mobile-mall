					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="yonghuzhanghao" id="yonghuzhanghao" placeholder="用户账号"
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="yonghuxingming" id="yonghuxingming" placeholder="用户姓名"
									   autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="mima" id="mima" placeholder="密码" autocomplete="off"
									   class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<select name="xingbie" id="xingbie">
									...
									<option v-for="(item,index) in xingbie" v-bind:key="index" :value="item">{{item}}
									</option>
								</select>
							</div>
						</div>
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="lianxidianhua" id="lianxidianhua" placeholder="联系电话"
									   autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="dianziyouxiang" id="dianziyouxiang" placeholder="电子邮箱"
									   autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="number" name="money" id="money" placeholder="余额" autocomplete="off"
							...
							<div class="layui-input-inline">
								<input type="number" name="jifen" id="jifen" placeholder="积分" autocomplete="off"
									   class="layui-input" disabled="disabled">
							</div>--%>
						</div>
