...
/*
            $('#suqiuupload').fileupload({
                url: 'http://localhost:8080/shoujishangcheng/file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: 'json',
                done: function (e, data) {
                    UE.getEditor('suqiuEditor').execCommand('insertHtml', '<img src=\"http://localhost:8080/shoujishangcheng/file/upload/' + data.result.file + '\" width=900 height=560>');
                }
            });
